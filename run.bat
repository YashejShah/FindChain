...
start "FindChain - Blockchain" cmd /k "cd /d %~dp0 && color 0A && echo. && echo  ╔══════════════════════════════════════════╗ && echo  ║   FindChain - Local Blockchain Node      ║ && echo  ║   http://127.0.0.1:8545  Chain: 31337   ║ && echo  ║   DO NOT CLOSE THIS WINDOW              ║ && echo  ╚══════════════════════════════════════════╝ && echo. && npx hardhat node"
